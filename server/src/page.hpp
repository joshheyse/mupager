...
public:
  ...
  static Page render(const Document& doc, int page_num, const RenderParams& params, float base_zoom, const HighlightParams& highlights, Frontend& frontend);
