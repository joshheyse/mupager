...
### 11. Multiple Graphics Protocols

- Abstract graphics output behind a protocol interface
- **Kitty** (current): full implementation
- **Sixel**: wide terminal support (xterm, foot, mlterm, WezTerm)
- **iTerm2 inline images**: macOS Terminal.app, iTerm2
- Auto-detect protocol from `$TERM`/`$TERM_PROGRAM` or `--protocol` flag
- Fallback: ASCII/block character rendering
